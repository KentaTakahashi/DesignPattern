package Exercises.ch07_Builder.ex07_02;
...
public class HTMLBuilder extends Builder {
    ...
    public void init(String title) {                       // HTMLファイルでのタイトル
    ...
    public void doString(String str) {                        // HTMLファイルでの文字列
        writer.println("<p>" + str + "</p>");                       // <p>タグで出力
    }
    public void doItems(String[] items) {                     // HTMLファイルでの箇条書き
